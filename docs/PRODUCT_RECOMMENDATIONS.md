...
4. **Secure privileged access.** Problem: PIN is UI state and vault retains revealable passwords. Solution: server-authorized owner commands, PIN rate limiting/expiry, password reset instead of reveal. Value: protects real money/data; complexity M; risk P1.
