    ...
    <header className="h-16 border-b glass-bar flex items-center justify-between px-4 md:px-6 sticky top-0 z-40">
      <div className="flex items-center gap-3">
        ...
        {!isAdmin && activeSeason && (
          <Badge
            variant="secondary"
            className={`text-xs font-medium px-3 py-1.5 rounded-full border border-primary/20 transition-colors flex items-center gap-1.5 ${canNavigateToSeasons ? "cursor-pointer hover:bg-primary/10" : "cursor-default"
              }`}
            onClick={() => {
