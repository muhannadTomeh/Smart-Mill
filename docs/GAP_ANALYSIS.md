...
| Credential vault | encrypted recoverable passwords and reveal capability | Partial | high-impact credential exposure | replace reveal with reset; audit/limit break-glass | P1 Must Fix Before Delivery |
