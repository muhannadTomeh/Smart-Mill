-- ===== Migration: 20240324000000_daily_inventory.sql =====
...
-- ===== Migration: 20240324000001_contact_settings.sql =====
...
-- ===== Migration: 20240813000000_add_mill_employee_role.sql =====
...
-- ===== Migration: 20260308202752_dc78ed1f-38f3-4841-874d-b70f805f49d4.sql =====
...
-- ===== Migration: 20260308214910_1f76e00a-d9c0-44ba-9c05-cfe25bf8d9c8.sql =====
...
-- ===== Migration: 20260308225653_fc2ecda5-c3d5-4ffa-be10-8f56dca92a0b.sql =====
...
-- ===== Migration: 20260308231016_7362e2b6-bd05-4c20-98ab-645d84036f57.sql =====
ALTER TABLE public.queue ADD COLUMN status text NOT NULL DEFAULT 'waiting';

-- ===== Migration: 20260309011742_0c2cf5d7-753b-4c83-8d7e-716d72c72a57.sql =====
ALTER TABLE public.workers ADD COLUMN phone text;
ALTER TABLE public.worker_payments ADD COLUMN notes text;

-- ===== Migration: 20260309022006_8b1c8209-713b-429d-9b93-01c580fb36f6.sql =====
...
-- ===== Migration: 20260309034835_a17599cb-a081-4363-8e15-ada3116734b3.sql =====
...
-- ===== Migration: 20260309034934_3fecf86c-2883-42b5-ade2-d1a76cd67546.sql =====
...
-- ===== Migration: 20260801014812_13461a4e-af87-4701-bc62-5a7e9ede00b2.sql =====
ALTER TABLE public.queue REPLICA IDENTITY FULL;
ALTER PUBLICATION supabase_realtime ADD TABLE public.queue;

-- ===== Migration: 20260802004703_a62e5c77-e981-456e-b205-3c729490cb3a.sql =====
...
-- ===== Migration: 20260802004953_2beb5050-1a1c-4802-aab3-f970cd1fe329.sql =====
CREATE OR REPLACE FUNCTION public.handle_new_user_setup()
RETURNS trigger
LANGUAGE plpgsql
SECURITY DEFINER
...
-- ===== Migration: 20260802010206_62f2d43e-9450-4bf8-a777-30a64854a762.sql =====
...
-- ===== Migration: 20260803231305_f0d5d198-7f61-4b35-8f0e-82574b753340.sql =====
...
-- ===== Migration: 20260804144052_e4f9501e-c78d-47e2-9b97-2c627a1b1252.sql =====
...
-- ===== Migration: 20260805103537_de205a92-cfa4-4b7b-a8e2-e41b91415de5.sql =====
...
-- ===== Migration: 20260805123142_c6f6b1f5-9161-4b22-9346-70c72164fb23.sql =====
...
-- ===== Migration: 20260809145224_8741f870-a0c8-4924-8935-d653cbd7d895.sql =====
DO $$
BEGIN
...
-- ===== Migration: 20260809145246_1bdb11ad-004a-4368-b701-999dee0f9659.sql =====
...
-- ===== Migration: 20260809145307_148f66f8-7063-42bc-92f9-170e0ee56385.sql =====
DO $$
DECLARE
    func_record RECORD;
BEGIN
...
-- ===== Migration: 20260809145324_ec090c91-6184-409f-97df-c35ec9d8ae95.sql =====
...
-- ===== Migration: 20260809145516_f70ccbcb-8b27-43db-ac78-5ab089994e71.sql =====
DO $$
DECLARE
    t_name text;
    tables text[] := ARRAY[
...
-- ===== Migration: 20260809145632_278fddc8-cb2b-4f6a-beea-022dce830dcb.sql =====
...
-- ===== Migration: 20260809145703_2e9e8fea-418e-4408-a6a8-f6704ba888df.sql =====
...
-- ===== Migration: 20260809150227_b5400c83-e642-44fa-a625-0ca865a094f8.sql =====
...
-- ===== Migration: 20260809150848_85ba1a89-8f54-45f7-b3e1-367ad29ac1d9.sql =====
...
-- ===== Migration: 20260809152521_6a379046-153b-4e24-b172-24e92cf698dc.sql =====
...
-- ===== Migration: 20260809154800_secure_reports_pin.sql =====
...
-- ===== Migration: 20260809154854_20a591e4-c3b2-41c3-a1d0-13fb25c4441f.sql =====
-- Enable pgcrypto if not already enabled
CREATE EXTENSION IF NOT EXISTS pgcrypto;
...
-- ===== Migration: 20260809164146_2cd98a93-21ad-4553-80ba-bff0aa72601d.sql =====
...
-- ===== Migration: 20260809164225_01bb4dd0-43ea-4494-8d64-fc25e43ba507.sql =====
...
-- ===== Migration: 20260809164523_33e704e2-1ec2-4033-9bc3-9a0cb6d50ba8.sql =====
...
-- ===== Migration: 20260813200906_worker_atomic_operations.sql =====
...
-- ===== Migration: 20260813204000_fix_profile_metadata.sql =====
...
-- ===== Migration: 20260813211812_15338bab-b8c1-4b6e-985d-49ed2df51a85.sql =====
...
-- ===== Migration: 20260815212042_a902e3d4-8fb4-4774-b403-94aeae18dd47.sql =====
-- 1. Get the user ID
DO $$
DECLARE
    target_user_id UUID;
...
-- ===== Migration: 20260815212243_69da2609-3dc8-47d1-aaa5-97cc7e83175a.sql =====
...
-- ===== Migration: 20260815220000_admin_update_profiles.sql =====
...
-- ===== Migration: 20260815220334_385ced3d-47a3-4492-a08c-db61252bf141.sql =====
-- Allow platform admins to update all profiles
DO $$
BEGIN
    IF NOT EXISTS (
...
-- ===== Migration: 20260815221303_f0897211-acf0-4526-bbf1-936e040024f1.sql =====
...
-- ===== Migration: 20260815221801_b807adda-d600-4da7-9af2-a3cac2cbfe57.sql =====
...
-- ===== Migration: 20260815222458_990314ac-6e35-4224-a1f3-7ecf96c9e3fe.sql =====
...
-- ===== Migration: 20260815222815_206c6a17-2761-428c-bd8e-e9dd1b3b1719.sql =====
...
-- ===== Migration: 20260815225838_9380e9fc-3f1e-4634-ad5a-7419f3365d19.sql =====
...
-- ===== Migration: 20260815225917_07605091-007a-40f5-b1b0-7588de11c411.sql =====
...
-- ===== Migration: 20260818091025_9ae2db9d-c919-40e6-9f36-067943329576.sql =====
...
-- ===== Migration: 20260818091053_4635811d-d7c1-4f75-b0b1-487fe9216a44.sql =====
...
-- ===== Migration: 20260822022949_23dab607-5aef-4ad8-b5f3-17371ba8c7a1.sql =====
